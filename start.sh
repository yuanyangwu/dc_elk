...
echo "Launch ELK"
docker run -p 5601:5601 -p 9200:9200 -p 5044:5044 -p 5000:5000 -v $( pwd ):/dc_elk -d -e ES_HEAP_SIZE="2g" -e LS_HEAP_SIZE="1g" --name $NAME sebp/elk

echo "Wait for ELK launch completion"
sleep 10

echo "Import DC logs at $1"
docker exec -it $NAME /dc_elk/import_dc.sh /dc_elk/$1
